...
import com.doug.config.ApplicationProperties;
import com.doug.config.DefaultProfileUtil;
...
public class LearningApp {
    ...
    public LearningApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(LearningApp.class);
